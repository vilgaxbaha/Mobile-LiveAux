...
class SocicalAccounts extends React.Component {
  loginFacebook = async () => {
    try {
  ...
  render() {
    ...
    if (!toggleLoginFacebook && !toggleLoginGoogle && !toggleLoginSMS) {
      return null;
    }
    return (
...
export default connect(mapStateToProps)(withNavigation(SocicalAccounts));
